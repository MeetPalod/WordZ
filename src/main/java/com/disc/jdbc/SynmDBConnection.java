...
public class SynmDBConnection {
    
    public static Connection connection = null;
    
    public static void main() throws IOException, SQLException, ClassNotFoundException{ //String args[]
    ...
    public static Connection getConnection() throws IOException, SQLException, ClassNotFoundException{
        ...
        try {
            if (connection == null || connection.isClosed()) {
                ...
                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/thesauraus", "root", "meetpalod");
    ...
    public static void close() throws SQLException {
        SynmDBConnection.connection.close();
